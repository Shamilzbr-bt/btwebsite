...
<div class="breadcrumb-wrapper bg-cover" style="background-image: url('assets/img/breadcrumb/contact.jpeg');">
    <!-- <div class="border-shape">
        <img src="assets/img/element.png" alt="shape-img">
    </div> -->
    <div class="line-shape">
        <img src="assets/img/breadcrumb/line-element.png" alt="shape-img">
    </div>
    <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="contact-left-items">
                        <div class="contact-info-area-2">
                            <div class="contact-info-items mb-4">
                                ...
                                <div class="content">
                                    <p>Call Us 7/24</p>
                                    <h3>
                                        <a href="tel:+965-22211226">+965-22211226</a>
                                    </h3>
                                </div>
                            </div>
                            <div class="contact-info-items mb-4">
                                ...
                                <div class="content">
                                    <p>Make a Quote</p>
                                    <h3>
                                        <a href="mailto:info@blocktech.com.kw">info@blocktech.com.kw</a>
                                    </h3>
                                </div>
                            </div>
                        ...
                        <div class="video-image">
                            <img src="assets/img/contact/contact.jpg" alt="img">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
